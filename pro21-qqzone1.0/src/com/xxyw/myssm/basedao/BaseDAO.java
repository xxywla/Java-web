package com.xxyw.myssm.basedao;
...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.xxyw.myssm.basedao.DAOException("BaseDAO 构造方法出错了，可能的原因是没有指定<>中的类型");
        }

    }

    protected Connection getConn() {
        return com.xxyw.myssm.basedao.ConnUtil.getConn();
    }
    ...
    protected int executeUpdate(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.xxyw.myssm.basedao.DAOException("BaseDAO executeUpdate出错了");
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.xxyw.myssm.basedao.DAOException("BaseDAO executeComplexQuery出错了");
        }
    ...
    protected T load(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.xxyw.myssm.basedao.DAOException("BaseDAO load出错了");
        }
    ...
    protected List<T> executeQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new com.xxyw.myssm.basedao.DAOException("BaseDAO executeQuery出错了");
        }
        return list;
    }
}
